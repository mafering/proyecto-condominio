...
public class IntegralTests1 {
	...
	public void Inicio() throws ParseException {
		...
		cuota.registrarCuotas(regVivienda.getVivienda("viv0001"),201105,2000, new SimpleDateFormat("dd/MM/yyyy").parse("15/05/2011"));
		cuota.registrarCuotas(regVivienda.getVivienda("viv0001"),201106,1500,new SimpleDateFormat("dd/MM/yyyy").parse("15/06/2011"));
		cuota.registrarCuotas(regVivienda.getVivienda("viv0001"),201107,800,new SimpleDateFormat("dd/MM/yyyy").parse("15/07/2011"));
		cuota.registrarCuotas(regVivienda.getVivienda("viv0001"),201108,1200,new SimpleDateFormat("dd/MM/yyyy").parse("15/08/2011"));
	}
	@Test
	public void PagandoCuotasVencidas() throws ParseException //throws ParseException {
	{
		
		PagodeCuotas pagoCuota=new PagodeCuotas(cuota.getCuotas());
		ConsultaDeMorosos consultaMoroso = new ConsultaDeMorosos(cuota.getCuotas());
		
		Date fechaActual = new SimpleDateFormat("dd/MM/yyyy").parse("10/08/2011");
