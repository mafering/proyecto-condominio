...
public class ConsultaVisitanteTests {
	...
	public void Inicio() throws Exception {
		...
		// registra visitas
		Visita objVisita1 = registrovisita.registrarVisita(regVisitante
				.getVisitante("vis0001"), regVivienda.getVivienda("viv0001"),
				new SimpleDateFormat("dd/MM/yyyy").parse("10/08/2011"));
		Visita objVisita2 = registrovisita.registrarVisita(regVisitante
				.getVisitante("vis0002"), regVivienda.getVivienda("viv0002"),
				new SimpleDateFormat("dd/MM/yyyy").parse("11/08/2011"));
		Visita objVisita3 = registrovisita.registrarVisita(regVisitante
				.getVisitante("vis0003"), regVivienda.getVivienda("viv0003"),
				new SimpleDateFormat("dd/MM/yyyy").parse("12/08/2011"));
		...
		registrovisita.registrarIngresoSalidaVisita(objVisita1,
				new SimpleDateFormat("dd/MM/yyyy hh:mm")
						...
						"dd/MM/yyyy hh:mm").parse("10/08/2011 15:30"));

		registrovisita.registrarIngresoSalidaVisita(objVisita2,
				new SimpleDateFormat("dd/MM/yyyy hh:mm")
						.parse("11/08/2011 10:30"), new SimpleDateFormat(
						"dd/MM/yyyy hh:mm").parse("11/08/2011 15:30"));

		registrovisita.registrarIngresoSalidaVisita(objVisita3,
				new SimpleDateFormat("dd/MM/yyyy hh:mm")
						.parse("12/08/2011 10:30"), new SimpleDateFormat(
						"dd/MM/yyyy hh:mm").parse("12/08/2011 15:30"));
